...
export default function InputPassword({type, id, name, required}:InputPasswordProps) {
    return (
        <div>
            <label htmlFor={id}>
            ...
            <div className="relative">
                ...
                <div className="size-[24px] text-slate-300 absolute right-3 top-1/2 -translate-y-1/2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" className="size-full">
